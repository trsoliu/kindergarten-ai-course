...
生活场景图为 AI 生成后放入 `assets/`；同一张内容图片不在不同教学页重复使用，开场、举手提问、单个助手案例、游戏引入和最终总结分别使用不同场景。
豆包图标来自豆包官网公开 favicon 资源，小爱同学完整标志来自小米公开品牌规范资料，小艺图标和名称组合参照华为官网小艺页面，用于课堂识别。
课堂主题页使用非品牌化的主题标识，避免把概念图标误当成品牌 logo。
